...
const BookCategoryCard = () => {
    return (
      <div className="flex flex-col md:flex-row gap-5 justify-center items-center mb-10">
        <div className="card bg-base-100 border-2 hover:bg-base-300 shadow-xl p-4 rounded-lg">
        ...
        <div className="card bg-base-100 hover:bg-base-300 border-2 shadow-xl p-4 rounded-lg">
